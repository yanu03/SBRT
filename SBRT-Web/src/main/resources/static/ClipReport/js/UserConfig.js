...
/***
 * EXE 메인 브라우저 message에 해당하는 Alert창 활성화
 * 
 * @param message {String} Alert 창에 출력할 메시지
 * @since version 1.0.0.331 
 * @since version 5.0.94
 */
...
/***
 * EXE 서브 브라우저 message에 해당하는 Alert창 활성화
 * 
 * @param message {String} Alert 창에 출력할 메시지
 * @since version 1.0.0.331 
 * @since version 5.0.94
 ...
 * @since version 5.0.94
 */
function SubWebBrowserCtrl_PlayScreen() {
	try {
		var layOutDiv = document.createElement("div");
		layOutDiv.id="m_ElayoutVideo";
		layOutDiv.style.cssText =  "position:absolute;left:0px;right:0px;top:0px;bottom:0px;z-index:5000;background-color:black";
		...
		video.controls = true;
		video.src = "./video/bear.mp4";
		layOutDiv.appendChild(video);
		
		document.body.appendChild(layOutDiv);
		
		video.play();
	} catch (e) {
		exeMirroringReportWebLog(e.stack);
	}
}

/***
 * EXE 에서 재생중인 영상을 정지하기 위한 함수
 *  
 * @since version 1.0.0.331 
 * @since version 5.0.94
 */
function SubWebBrowserCtrl_StopScreen() {
	try{
		var layOutDiv = document.getElementById("m_ElayoutVideo");
