...
function distributeHeight(els, availableHeight, shouldRedistribute) {
	...
	// *FLOORING *: we floor in certain places because zoom can give inaccurate floating-point dimensions,
	// and it is better to be shorter than taller, to avoid creating unnecessary scrollbars.

	var minOffset1 = Math.floor(availableHeight / els.length); // for non-last element
	var minOffset2 = Math.floor(availableHeight - minOffset1 * (els.length - 1)); // for last element *FLOORING *
...
// : should use clientLeft/clientTop, but very unreliable cross-browser.
...
/*
GENERAL  on moments throughout the *entire rest* of the codebase:
...
DragListener.mixin({
	...
	// Get called when the scrollEl is scrolled (: this is delayed via debounce)
...
var Component = Model.extend({
	...
	removeElement: function() {
		...
		this.el.remove();
		// : don't null-out this.el in case the View was destroyed within an API callback.
	...
	/*
	: Can't have a `render` method. Read the deprecation notice in View::executeDateRender
	*/
...
var InteractiveDateComponent = FC.InteractiveDateComponent = DateComponent.extend({
	...
	// : very similar to isExternalInstanceGroupAllowed
	...
	// : very similar to isEventInstanceGroupAllowed
...
// ------------------------------------------------------------------------------------------------
// : this might seem like repetitive code with the Grid class, however, this code is related to
...
// : can't guarantee any of these computations will run because not every locale has datepicker
...
var EventDef = FC.EventDef = Class.extend(ParsableModelMixin, {
	...
	// : eventOrder sorting relies on these
	title: null,
	url: null,
	rendering: null,
	constraint: null,
...
var SingleEventDef = EventDef.extend({
	...
	*/
	...
	/*
	: if super-method fails, should still attempt to apply
	*/
	applyManualStandardProps: function(rawProps) {
...
----------------------------------------------------------------------------------------------------------------------*/
// : all the segs being passed around in here are foreground segs
...
var TimeGrid = FC.TimeGrid = InteractiveDateComponent.extend(StandardInteractionsMixin, DayTableMixin, {
	...
	releaseHits: function() {
		this.colCoordCache.clear();
		// : don't clear slatCoordCache because we rely on it for computeTimeTop
	},
