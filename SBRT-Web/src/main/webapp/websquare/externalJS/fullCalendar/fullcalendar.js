...
// : this method is best because it takes weird zooming dimensions into account
...
var Grid = fc.Grid = RowRenderer.extend({
	...
	removeElement: function() {
		...
		// : we don't null-out this.el for the same reasons we don't do it within View::removeElement
	},
...
function Calendar_constructor(element, overrides) {
	...
	var currentView; // : keep this in sync with this.view
	...
	function destroy() {
		...
		if (currentView) {
			...
			// : don't null-out currentView/t.view in case API methods are called after destroy.
...
// : can't guarantee any of these computations will run because not every language has datepicker
...
function EventManager(options) { // assumed to be a calendar
	...
	// : mutates the given start/end moments. does not make a copy.
	...
	// : The given `newProps` might be mutated for normalization purposes.
